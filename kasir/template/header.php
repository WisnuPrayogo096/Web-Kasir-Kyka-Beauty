...
<head>
  ...
  <title>Beranda Kasir  | Kasir</title>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          ...
          <img src="../admin/img/967-kasir logoZ.png" height="150">        </div>
        <div class="info">
          <a href="index.php?m=detail" class="d-block" >kasir</a>
        </div>
      </div>
      ...
      <a href="logout.php"><button class="btn btn-danger mt-2">Logout</button></a>
